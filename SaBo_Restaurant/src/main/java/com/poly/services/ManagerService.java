...
public class ManagerService {
	...
	public Map<String, Long> statistic() {
		...
		map.put("userNumber", userAccountRepository.countByRoleId(2));
		map.put("restaurantNumber", restaurantRepository.count());
		map.put("bookingNumber", bookingRepository.count());
